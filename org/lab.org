...
In this we go through the various steps required to obtain the 
...
Similarly to the data plot from the benchmark results, the command analyze will allow to recreate the graphs we have used:
#+BEGIN_SRC sh
