...
\SR{Next sentence unclear}
Secondly, the difference between the computed maximum and minimum
values is only from $2\%$ to $10\%$ the maximum value. This
demonstrates the precision of our performance model.
