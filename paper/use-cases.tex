...
Figure~\ref{fig:full} depicts the use-case from the sysadmin or devops viewpoint 
...
\HC[Charlène]{Merci de donner quelques détails techniques sur les requêtes 
effectuées, le fait qu'on a pas accès à des log vieux de plus de X jours etc.}
...
\begin{center}
	...
	\caption{Projection of the OpenStack CI traces with our reference experimental 
			measured time in \emph{remote} mode on \ecotype 		
