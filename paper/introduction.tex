...
\CP[all]{Intro est raide!}
%correction: software is uncountable
A distributed software is asoftware designed in a modular architectural style
...
%
\CP[all]{Ne faudrait il pas commencer l'intro avec une description approximative
puis ensuite préciser le choix de nos termes?}
%
...
commissioning does not include \CP[all]{pourquoi dynamic? reconf n'est pas suffisant?} dynamic reconfiguration aspects of the
...
writing the functional code of the component. \CP{où est le second?} Thirdly, components
...
\CP{Cela me gène car les gens utilisent des distributions linux par exemple pour se simplifier la vie.}
...
\CP[all]{Trop d'aspects sont abordés sans qu'on comprenne quel est l'objectif}
\CP[all]{Il faudrait dire avant quel est l'objectif, genre automatiser le deploiement}
...
parallelism expressivity; and (3) the formalization of \CP{the tool???} such
