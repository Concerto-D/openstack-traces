...
\begin{figure*}[t!]
  \begin{center}
    ...
    \caption{Examples to illustrate the four parallelism levels
      considered in this paper. Plain arrows represent tasks to perform within deployments, their length corresponding to their duration. Dashed arrows represents dependencies or coordination between components or modules. The finer the dependencies are specified, the higher the level of parallelism is, and the shorter is the deployment time.}
    \label{fig:parlevels}
  \end{center}
\end{figure*}
