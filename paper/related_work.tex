  ...
  \begin{center}
    \subfloat[SIMH]{
      \fcolorbox{black!20}{white}{
        \begin{minipage}[c][7.5cm][c]{0.43\linewidth}%
          \centering
    ...
    \subfloat[inter-comp]{
      \fcolorbox{black!20}{white}{
        \begin{minipage}[c][7.5cm][c]{0.43\linewidth}%
          \centering
          \scalebox{0.43}{\input{./figures/inter-comp.tex}}
        \end{minipage}
    ...
    \subfloat[inter-comp-tasks]{
      \fcolorbox{black!20}{white}{
        \begin{minipage}[c][5cm][c]{0.43\linewidth}%
          \centering
          \scalebox{0.46}{\input{./figures/inter-comp-tasks.tex}}
        \end{minipage}
    ...
    \subfloat[intra-comp-tasks]{
      \fcolorbox{black!20}{white}{
        \begin{minipage}[c][5cm][c]{0.43\linewidth}%
          \centering
          \scalebox{0.48}{\input{./figures/intra-comp-tasks.tex}}
        \end{minipage}
