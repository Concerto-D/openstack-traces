...
(\eg modules, services, micro-services) across a large number of physical machines 
or virtual machines. Deploying such systems is a challenging domain that is often 
...
%
For many years the automation of the deployment process is recognized as a 
difficult problem that need coordination mechanisms and programming support. In 
...
paradigms. In this paper three particular metrics are extensively studied and 
enhanced compared to the related work: (1) the separation of concerns between 
actors of a deployment process (developers, DevOps engineers, systems 
administrators etc.); (2) the performance in terms of parallelism expressiveness; 
and (3) the ability of the solution to be formalized which opens to formal 
...
real complex use-case, \ie the deployment of the de-facto open-source solution to 
address the IaaS level of the Cloud paradigm: OpenStack. Its deployment time is 
reduced up to 71\% compared to the related work.
\end{abstract}
