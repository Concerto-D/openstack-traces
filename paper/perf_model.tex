In this section, we present a performance model for \mad. Its goal is to
...
\]
\MC[Maverick]{TODO : vérifier si on peut fusionner les deux sommets de place}
...
\SR{On peut sans doute retirer les vertices representant les ports, et directement connecter $v^{place}_\pi$ à $v^{beg}_\theta$.}
