In this section, the \mad formal model is presented, in a streamlined
...
\begin{minipage}[h]{0.45\columnwidth}%
  ...
  \captionof{figure}{\label{fig:r3}Rule $\reachplace$.}
\end{minipage}
\hfill
\begin{minipage}[h]{0.45\columnwidth}%
  \centering
  \includegraphics[width=0.65\columnwidth]{./images/place_to_outputdocks.pdf}
  \captionof{figure}{\label{fig:r4}Rule $\leaveplace$.}
\end{minipage}
\end{figure}
