  ...
  \subfloat[Dependency graph]{%
    \begin{minipage}[c]{1.2\columnwidth}%
      ...
      \begin{tikzpicture}[node distance=2cm]
        ...
        \node (t2) [beginning, right of=p1l, xshift=1.5cm] {$v_\text{t2}^\text{beginning}$};
        \node (t2e) [end, right of=t2, xshift=1.5cm] {$v_\text{t2}^\text{end}$};
        ...
        \node (t3e) [end, right of=p3, xshift=1.5cm] {$v_\text{t3}^\text{end}$};
  ...
  \subfloat[Dependency graph]{%
    \begin{minipage}[c]{1.4\columnwidth}%
      ...
      \begin{tikzpicture}[node distance=2cm]
        ...
        \node (dp) [provide_start, right of=c1p1, xshift=1.5cm] {$v_\text{dp}^\text{start}$};
        \node (du) [use_start, right of=dp, xshift=1.5cm] {$v_\text{du}^\text{start}$};
        \node (c2t) [beginning, right of=du, xshift=1.5cm] {$v_\text{c2t}^\text{beginning}$};
