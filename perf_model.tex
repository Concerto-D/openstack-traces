  ...
  \subfloat[Dependency graph]{%
    \begin{minipage}[c]{0.5\columnwidth}%
      ...
      \begin{tikzpicture}[node distance=2cm]
        ...
        \node (t2) [beginning, right of=p1l, xshift=1cm] {$v_\text{t2}^\text{beginning}$};
        \node (t2e) [end, right of=t2, xshift=1cm] {$v_\text{t2}^\text{end}$};
        ...
        \node (t3e) [end, right of=p3, xshift=1cm] {$v_\text{t3}^\text{end}$};
        \draw [arrow] (p3) -- (p3l);
        \draw [arrow] (p2) -- (p2l);
        \draw [arrow] (p1) -- (p1l);
        \draw [arrow] (t3) -- (t3e);
  ...
  \subfloat[Dependency graph]{%
    \begin{minipage}[c]{1.3\columnwidth}%
      ...
      \begin{tikzpicture}[node distance=1.5cm]
        ...
        \draw [arrow] (c1t1_end) -- (c1p1);
        \draw [arrow] (c1p1) -- (c1p1l);
        \draw [arrow] (c1p1l) -- (c1t2);
        \node (dp) [provide_start, right of=c1p1, xshift=1cm] {$v_\text{dp}^\text{start}$};
        \node (du) [use_start, right of=dp, xshift=1cm] {$v_\text{du}^\text{start}$};
        \node (c2t) [beginning, right of=du, xshift=1cm] {$v_\text{c2t}^\text{beginning}$};
        \node (c2t_end) [end, above of=c2t] {$v_\text{c2t}^\text{end}$};
        \draw [arrow] (c2t) -- (c2t_end);
        \draw [arrow] (c1p1) -- (dp);
        \draw [arrow] (dp) -- (du);
        \draw [arrow] (du) -- (c2t);
      \end{tikzpicture}
  ...
  \subfloat[Dependency graph]{%
    \begin{minipage}[c]{1.3\columnwidth}%
      ...
      \begin{tikzpicture}[node distance=1.5cm]
        ...
        \draw [arrow] (c1p1) -- (c1p1l);
        \draw [arrow] (c1p1l) -- (c1t2);
        \draw [arrow] (c1t2) -- (c1t2_end);
        \draw [arrow] (c1t2_end) -- (c1p2);
        \draw [arrow] (c1p2) -- (c1p2l);
        \draw [arrow] (c1p2l) -- (c1t3);
        ...
        \draw [arrow] (sp) -- (su);
        \draw [arrow] (su) -- (c2t);
        \draw [arrow] (c2t_end) -- (sus);
        \draw [arrow] (sus) -- (sps);
        \draw [arrow] (sps) -- (c1p2l);
      \end{tikzpicture}
    \end{minipage}
  }
...
\begin{figure*}[h]
  ...
  \subfloat[Dependency graph]{%
    \begin{minipage}[c]{0.5\columnwidth}%
      \centering
      \begin{tikzpicture}[node distance=2cm]
        \node (c1p2l) [leaving] {$v_\text{p3}^\text{leaving}$};
        \node (c1p2) [place, below of=c1p2l] {$v_\text{p3}^\text{place}$};
        \node (c1t1e) [end, below of=c1p2] {$v_\text{t1}^\text{end}$};
        \node (c1t1) [beginning, below of=c1t1e] {$v_\text{t1}^\text{beginning}$};
        \node (c1p1l) [leaving, below of=c1t1] {$v_\text{p1}^\text{leaving}$};
        \node (c1p1) [place, below of=c1p1l] {$v_\text{p1}^\text{place}$};
        
        \node (c2p2l) [leaving, right of=c1p2l, xshift=0.5cm, yshift=-0.5cm] {$v_\text{p3}^\text{leaving}$};
        \node (c2p2) [place, right of=c1p2, xshift=1cm] {$v_\text{p3}^\text{place}$};
        \node (c2t1e) [end, below of=c2p2] {$v_\text{t1}^\text{end}$};
        \node (c2t1) [beginning, below of=c2t1e] {$v_\text{t1}^\text{beginning}$};
        \node (c2p1l) [leaving, below of=c2t1, xshift=1.5cm] {$v_\text{p1}^\text{leaving}$};
        \node (c2p1) [place, below of=c2p1l] {$v_\text{p1}^\text{place}$};
        
        \node (c2p3) [place, right of=c2p2, xshift=1cm] {$v_\text{p3}^\text{place}$};
        \node (c2p3l) [leaving, above of=c2p3] {$v_\text{p3}^\text{leaving}$};
        \node (c2t2e) [end, below of=c2p3] {$v_\text{t1}^\text{end}$};
        \node (c2t2) [beginning, below of=c2t2e] {$v_\text{t1}^\text{beginning}$};
        
        \node (source) [control, below of=c2p1, xshift=-1.5cm] {$v^\text{source}$};
        \node (sink) [control, above of=c1p2l, xshift=3cm] {$v^\text{sink}$};
        
        \draw [arrow] (c1p1) -- (c1p1l);
        \draw [arrow] (c1p2) -- (c1p2l);
        \draw [arrow] (c2p1) -- (c2p1l);
        \draw [arrow] (c2p2) -- (c2p2l);
        \draw [arrow] (c2p3) -- (c2p3l);
        \draw [arrow] (c1t1) -- (c1t1e);
        \draw [arrow] (c2t1) -- (c2t1e);
        \draw [arrow] (c2t2) -- (c2t2e);
        \draw [arrow] (c1p1l) -- (c1t1);
        \draw [arrow] (c2p1l) -- (c2t1);
        \draw [arrow] (c2p1l) -- (c2t2);
        \draw [arrow] (c1t1e) -- (c1p2);
        \draw [arrow] (c2t1e) -- (c2p2);
        \draw [arrow] (c2t2e) -- (c2p3);
        \draw [arrow] (source) -- (c1p1);
        \draw [arrow] (source) -- (c2p1);
        \draw [arrow] (c1p2) -- (sink);
        \draw [arrow] (c2p2) -- (sink);
        \draw [arrow] (c2p3) -- (sink);
      \end{tikzpicture}
    \end{minipage}
  }
