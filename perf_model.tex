  ...
  \subfloat[Dependency graph]{%
    \begin{minipage}[c]{1.3\columnwidth}%
      ...
      \begin{tikzpicture}[node distance=2cm]
        ...
        \node (c1p2) [place, below of=c1p2l] {$v_\text{p1p2}^\text{place}$};
        ...
        \node (c2p2l) [leaving, right of=c1p2l, xshift=0.5cm, yshift=-0.5cm] {$v_\text{c2p2}^\text{leaving}$};
        \node (c2p2) [place, right of=c1p2, xshift=1cm] {$v_\text{c2p2}^\text{place}$};
        ...
        \node (c2p3) [place, right of=c2p2, xshift=1cm] {$v_\text{c2p3}^\text{place}$};
        \node (c2p3l) [leaving, above of=c2p3] {$v_\text{c2p3}^\text{leaving}$};
